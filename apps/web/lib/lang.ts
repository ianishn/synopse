...
export const UI = {
  fr: {
    ...
    customTitle: "Tes règles personnalisées", customHint: "Tes propres règles, en plus du catalogue. Évaluées localement, fail-safe comme les autres.",
    studioTeaser: "Crée tes propres règles en français, réservé au plan Studio.", goStudio: "Passer à Studio",
    newRule: "Créer une règle", ruleName: "Nom de la règle", ruleNamePh: "ex : Jamais de virement sans mon accord",
    whenLabel: "Quand", thenLabel: "Alors", createRule: "Créer la règle", noCustom: "Aucune règle personnalisée pour l'instant.",
    condAmount: "L'agent dépense plus de… (€)", condDomains: "L'agent contacte un domaine hors de ma liste",
    condTools: "L'agent utilise un de ces outils", condKeywords: "L'action contient un de ces mots",
    condHours: "L'agent agit entre ces heures", domainsPh: "mondomaine.fr, client.com (séparés par des virgules)",
    toolsPh: "send_email, exec (séparés par des virgules)", keywordsPh: "facture, virement, mot de passe",
    hoursFrom: "de", hoursTo: "à",
  ...
  en: {
    ...
    customTitle: "Your custom rules", customHint: "Your own rules on top of the catalog. Evaluated locally, fail-safe like the rest.",
    studioTeaser: "Create your own rules — Studio plan only.", goStudio: "Go Studio",
    newRule: "Create a rule", ruleName: "Rule name", ruleNamePh: "e.g. Never wire money without my approval",
    whenLabel: "When", thenLabel: "Then", createRule: "Create the rule", noCustom: "No custom rules yet.",
    condAmount: "The agent spends more than… (€)", condDomains: "The agent contacts a domain outside my list",
    condTools: "The agent uses one of these tools", condKeywords: "The action contains one of these words",
    condHours: "The agent acts between these hours", domainsPh: "mydomain.com, client.com (comma-separated)",
    toolsPh: "send_email, exec (comma-separated)", keywordsPh: "invoice, wire transfer, password",
