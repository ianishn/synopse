...
export default function Page() {
  return (
    <>
      ...
      <p>Plans : Gratuit (0 €), Protégé (9 € TTC/mois), Studio (19 € TTC/mois). Paiement mensuel par carte via Stripe, TVA collectée selon le pays de résidence. Résiliation à tout moment depuis le portail client ; l&apos;accès reste actif jusqu&apos;à la fin de la période payée.</p>
